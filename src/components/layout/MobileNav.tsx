...
export function MobileNav() {
    ...
    return (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 px-6 py-3 flex justify-between items-center rounded-t-3xl bg-white/70 backdrop-blur-xl shadow-[0_-10px_40px_rgba(26,43,72,0.05)]">
